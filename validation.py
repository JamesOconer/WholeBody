...
if __name__ == "__main__":
    ...
    # 数据集的根目录
    parser.add_argument('--data-path', default='/data/vfan/dataset/coco/', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights-path', default='multi_train/model_209.pth', type=str, help='training weights')
